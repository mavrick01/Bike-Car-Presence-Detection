#include secrets.h // My secrets file
////////////////////////////////////////////////////////////////////////////////////////////////////
// Modify these values for your environment
const char *wifiSSID = secret_SSID;                  // Your WiFi network name
const char *wifiPassword = "secret_WIFIPASS;          // Your WiFi network password
const char *otaPassword = secret_PASS;                       // OTA update password
const char *mqttServer = secret_MQTT_HOST;            // Your MQTT server IP address
const char *mqttUser = secret_MQTT_USER;                          // mqtt username, set to "" for no user
const char *mqttPassword = secret_MQTT_PASS;                      // mqtt password, set to "" for no password
const String mqttNode = secret_BIKE1;              // Your unique hostname for this device
...
#define MQTT_MAX_PACKET_SIZE 512                    //They recommend you update hte PubSub.h file, but I find you ccan override it here (must be before the include file)
...
void loop()
{
  ...
  delay(500); //I added in the delay as it was flashing far to reguarly for my liking. 
